...
formatter.step({
  "name": "user enters vin number as \"123456789123456AB\"",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "user should see \"We found your VIN, but weren’t able to identify your vehicle details. Please add the year, make, model, and trim below.\" text",
  "keyword": "Then "
});
formatter.match({
  "location": "CarvanaSteps.userShouldSeeText(String)"
